...
from vickrey_auction_GUI.vickrey_schedules import *
...
class BaseGui(App):
    def __init__(self, name, logging_client, exoboot_remote, bertec):
        self.sm = ScreenManager()
        self.sm.name = name

        # Set Logging client
        self.sm.logging_client = logging_client
