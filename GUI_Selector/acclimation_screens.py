...
from acclimation_schedules import finishscreenacclschedule
...
def buildsliderscreenaccl(sm):
    ...
    tslider = Slider(min = TORQUE_MIN, max=TORQUE_MAX, value = 20, step = ACCL_STEP, value_track=True, size_hint=(4/5, 2/3), pos_hint={'x':1/10, 'y':1/3})
