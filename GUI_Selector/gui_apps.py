...
class VickreyGUI(BaseGui):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            "VICKREY", exoboot_remote, filingcabinet, file_prefix, bertec, vicon
        )
    ...
    def build(self):
        ...
        if not usebackup:
            ...
            auctionpath = self.sm.filingcabinet.newfile(
...
class VASGUI(BaseGui):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            "VAS", exoboot_remote, filingcabinet, file_prefix, bertec, vicon
        )
        self.usebackup = usebackup
        self.sm.allow_check_batteries = allow_check_batteries
        self.subject_dict = subject_dict
...
class JNDGUI(BaseGui):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            "JND", exoboot_remote, filingcabinet, file_prefix, bertec, vicon
        )
...
class PREFGUI(BaseGui):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            "PREFERENCE", exoboot_remote, filingcabinet, file_prefix, bertec, vicon
        )
...
class AcclimationGUI(BaseGui):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            "ACCLIMATION", exoboot_remote, filingcabinet, file_prefix, bertec, vicon
        )
...
class ControlPanelGUI(BaseGui):
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            "CONTROLPANEL", exoboot_remote, filingcabinet, file_prefix, bertec, vicon
        )
        self.sm.subject_dict = subject_dict
