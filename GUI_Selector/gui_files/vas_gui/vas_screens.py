...
def buildwaitingscreenvas(sm):
    """
    Enforce minimum wait between VAS rounds
    """
...
def buildvasscreen(sm, screen, confirmed=False, ranked=None):
    """
    VAS screen for evaluation of torques
    Sliders, torque buttons, and confirm button
    """
    def onslidermotion(instance, mvalue):
        """
        Log value overtime for each slider
        """
        sm = instance.parent.parent
    ...
    def buildsliders(sm, screen, sliders_origin={'x':0, 'y':0}, sliders_size=(0, 0), ranked=None, slider_min=0, slider_max=100):
        """
        Build set of slider and add to screen
        """
